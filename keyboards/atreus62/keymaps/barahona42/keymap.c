...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT( /* qwerty */
        ...
        _______,        KC_LCTL,        KC_LALT,        KC_LGUI,        MO(_LOWER),     KC_SPC,          TT(_NUMS),        MO(_FN1),     KC_SPC,         MO(_RAISE),     KC_RGUI,        KC_RALT,        KC_RCTL,        KC_ENT
    ),
    [_LOWER] = LAYOUT(
        ...
        KC_CAPS,        _______,        _______,        _______,        _______,        _______,         _______,        _______,        _______,        MO(_FN1),       _______,        _______,        _______,        _______
    ),
    [_RAISE] = LAYOUT(
        _______,        _______,        _______,        _______,        _______,        _______,                                         _______,        _______,        _______,        _______,        _______,        _______,
        ...
        TD(TD_MDIA),    _______,        _______,        _______,        MO(_FN1),       _______,        _______,        _______,         _______,        _______,        _______,        _______,        _______,        _______
    ),
    [_FN1] = LAYOUT(
        _______,        _______,        _______,        _______,        _______,        _______,                                         _______,        _______,        _______,        _______,        _______,        _______,
    ...
    [_NUMS] = LAYOUT(
        _______,        _______,        _______,        _______,        _______,        _______,                                         _______,        KC_SLSH,        KC_ASTR,        _______,        _______,        _______,
        _______,        _______,        _______,        _______,        LSG(KC_TAB),    LGUI(KC_TAB),                                    KC_7,           KC_8,           KC_9,           KC_MINS,        _______,        _______,
        _______,        _______,        _______,        _______,        LSG(KC_GRV),    LGUI(KC_GRV),                                    KC_4,           KC_5,           KC_6,           KC_PLUS,        _______,        _______,
        _______,        _______,        _______,        _______,        RCS(KC_TAB),    LCTL(KC_TAB),                                    KC_1,           KC_2,           KC_3,           _______,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,        _______,        _______,        _______,         KC_0,           KC_DOT,         _______,        KC_ENT,         _______,        _______
    ),
};
