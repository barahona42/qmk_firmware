...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_5x12(
        KC_GRV,      KC_1,       KC_2,       KC_3,        KC_4,        KC_5,      KC_6,        KC_7,        KC_8,          KC_9,       KC_0,       MO(_FN2),
    ...
    [_FN2] = LAYOUT_ortho_5x12(
        ...
        _______,     RCS(KC_TAB),KC_PGDN,    LCTL(KC_TAB),      _______,     _______,   _______,     _______,     _______,       _______,    _______,    _______,
