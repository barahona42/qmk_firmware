...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_5x12(
        ...
        TD(TD_MDIA), KC_LCTL,    KC_LALT,    KC_LGUI,     MO(_LOWER),  KC_SPC,    KC_SPC,      MO(_RAISE),  KC_RGUI,       KC_RALT,    KC_RCTL,       KC_ENT
    ...
    [_LOWER] = LAYOUT_ortho_5x12(
        ...
        _______,     TG(_NUMPAD),_______,    _______,     _______,     _______,   _______,     MO(_FN1),     _______,      _______,    _______,    _______
    ),
    [_RAISE] = LAYOUT_ortho_5x12(
        ...
        _______,     _______,    _______,    _______,     MO(_FN1),    _______,   _______,     _______,     MO(_FN2),      _______,    _______,    _______
    ),
    ...
    [_NUMPAD] = LAYOUT_ortho_5x12(
        ...
        _______,     TG(_NUMPAD),_______,    _______,     _______,     _______,   _______,     KC_0,        KC_0,          KC_DOT,     _______,    _______
    )
};
