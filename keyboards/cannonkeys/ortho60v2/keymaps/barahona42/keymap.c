...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [LAY1]  = {ENCODER_CCW_CW(_______, _______)},
    [LAY2]  = {ENCODER_CCW_CW(_______, _______)},
    [NUMS]    = {ENCODER_CCW_CW(_______, _______)},
    [NAVS]    = {ENCODER_CCW_CW(BL_DOWN, BL_UP)}
};
