...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_5x12(
        ...
        KC_LCTL,     KC_LALT,    KC_LGUI,    MO(_LOWER),  KC_SPC,                              KC_SPC,      MO(_RAISE),    KC_RALT,    KC_RCTL,    KC_ENT
    ),
    [_LOWER] = LAYOUT_ortho_5x12(
        ...
        _______,     _______,    _______,    _______,     _______,     _______,    _______,    _______,     _______,       _______,    _______,    _______,
        TG(_NUMPAD), _______,    _______,    _______,     _______,                             _______,     MO(_FN1),      _______,    _______,    _______
    ),
    [_RAISE] = LAYOUT_ortho_5x12(
        _______,     _______,    _______,    _______,     _______,     _______,   _______,     _______,     _______,       _______,    _______,    _______,
        _______,     KC_HOME,    KC_UP,      KC_END,      KC_PGUP,     _______,   _______,     _______,     KC_LPRN,       KC_RPRN,    KC_EQL,     KC_DEL,
        _______,     KC_LEFT,    KC_DOWN,    KC_RIGHT,    KC_PGDN,     _______,   _______,     _______,     KC_LBRC,       KC_RBRC,    _______,    KC_BSLS,
        _______,     KC_F12,     CACOM,      CADOT,       _______,     _______,   _______,     KC_MINS,     KC_LCBR,       KC_RCBR,    _______,    _______,
        _______,     _______,    _______,    MO(_FN1),    _______,                             _______,     _______,       _______,    _______,    _______
    ),
    ...
    [_NUMPAD] = LAYOUT_ortho_5x12(
        ...
        TG(_NUMPAD), _______,    _______,    _______,     _______,                             KC_SPC,      KC_0,          KC_DOT,     _______,    _______
    ),
};
